...
void ModeDrawStar::generate_path()
{
	...
	path[3] = path[0] + Vector3f(sinf(radians(36.0f/2)),cosf(radians(36.0f/2)), 0) * radius_cm;
	path[4] = path[0] + Vector3f(sinf(radians(36.0f/2)),-cosf(radians(36.0f/2)), 0) * radius_cm;
